        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <form class="form-horizontal">
              <div class="box-body">
                <div class="form-group">
                   <label for="kategori" class="col-sm-2 control-label">Categori</label>
                   <div class="col-sm-10">
                      <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true">
                        <option selected="selected">Categori</option>
                        <option>Web</option>
                        <option disabled="disabled">Desktop</option>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <textarea id="editor1" name="deskripsi-pekerjaan" rows="10" cols="70">
                    </textarea>
                  </div>
                </div>
