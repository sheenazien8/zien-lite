          ...
          <div class="box box-info">
            ...
            <form class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                   <label for="nama-lengkap" class="col-sm-2 control-label">Nama Lengkap</label>
                  <div class="col-sm-10">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="radio" name="status" class="minimal-red" value="superadmin"> Superadmin
                    <input type="radio" name="status" class="minimal-red" value="customer"> Customer
                  </div>
                </div>
