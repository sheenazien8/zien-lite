        ...
        <div class="row">
          <div class="col-lg-3">
            <div class="list-group">
              <a href="../kategori/" class=" list-group-item">Kategori</a>
              <a href="../barang/" class="list-group-item">Barang</a>
              <a href="../pesanan/" class="list-group-item">Pesanan</a>
              <a href="../user/" class="active list-group-item">User</a>
            </div>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-striped">
                <tr>
                  ...
                  <th style="width: 300px;">Nama Lnegkap</th>
                ...
                <tr>
                  <td>1</td>
                  <td>Sheena Muhammad Ali Zien</td>
                  <td>Sheena_zien</td>
                  <td>On</td>
